							...
							<Flex w={'20%'}>
								<Field name='matchDegreeType'>
									{({ field, form }) => (
										<FormControl
											isInvalid={
												form.errors.matchDegreeType && form.touched.matchDegreeType
											}
											mt={'20px'}>
											<FormLabel htmlFor='matchDegreeType'>
						...
						<Flex w={'50%'}>
							<Field name={'matchStudyCountry'}>
								{({ field, form }) => (
									<FormControl
										isInvalid={
											form.errors.matchStudyCountry && form.touched.matchStudyCountry
										}
										mt={'20px'}>
						...
						<Flex w={'50%'}>
							<Field name={'matchStudyCountryUni'}>
								{({ field, form }) => (
									<FormControl
										isInvalid={
											form.errors.matchStudyCountryUni &&
											form.touched.matchStudyCountryUni
										}
										mt={'20px'}>
										<FormLabel htmlFor='matchStudyCountryUni'>
						...
						<Flex w={'50%'}>
							<Field name={'matchStudyTitle'}>
								{({ field, form }) => (
									<FormControl
										isInvalid={
											form.errors.matchStudyTitle && form.touched.matchStudyTitle
										}
										mt={'20px'}>
